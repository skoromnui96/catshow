...
use app\models\Headerex\HeaderexSearch;
...
/**
 * HeaderexController implements the CRUD actions for Headerex model.
 */
class HeaderexController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all Headerex models.
     * @return mixed
     */

    /**
     * Displays a single Headerex model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new Headerex model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */

    /**
     * Updates an existing Headerex model.
    ...
    /**
     * Deletes an existing Headerex model.
     ...
     */
    /**
     * Finds the Headerex model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Headerex the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Headerex::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionSortImage($id)
    {
        if(Yii::$app->request->isAjax){
            ...
            ImageManager::updateAllCounters(['sort' => $counter], [
                'and',['class'=>'headerex','item_id'=>$id],$param
            ]);
