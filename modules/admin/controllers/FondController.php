...
use app\models\Fond\FondSearch;
...
/**
 * FondController implements the CRUD actions for Fond model.
 */
class FondController extends Controller
{
    ...
    /**
     * Creates a new Fond model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    /**
     * Updates an existing Fond model.
    ...
    /**
     * Deletes an existing Fond model.
     ...
     */
    /**
     * Finds the Fond model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Fond the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Fond::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionSortImage($id)
    {
        if(Yii::$app->request->isAjax){
            ...
            ImageManager::updateAllCounters(['sort' => $counter], [
                'and',['class'=>'fond','item_id'=>$id],$param
            ]);
