...
use app\models\Headersl\HeaderslSearch;
...
/**
 * HeaderslController implements the CRUD actions for Headersl model.
 */
class HeaderslController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all Headersl models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new HeaderslSearch();
    ...
    /**
     * Displays a single Headersl model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing Headersl model.
    ...
    /**
     * Deletes an existing Headersl model.
    ...
    /**
     * Finds the Headersl model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Headersl the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Headersl::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionSortImage($id)
    {
        if(Yii::$app->request->isAjax){
            ...
            ImageManager::updateAllCounters(['sort' => $counter], [
                'and',['class'=>'headersl','item_id'=>$id],$param
            ]);
