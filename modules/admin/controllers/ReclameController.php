...
use Yii;
use app\models\Reclame\Reclame;
use app\models\Reclame\ReclameSearch;
...
/**
 * ReclameController implements the CRUD actions for Reclame model.
 */
class ReclameController extends Controller
{
    ...
    /**
     * Lists all Reclame models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ReclameSearch();
    ...
    /**
     * Displays a single Reclame model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Updates an existing Reclame model.
    ...
    /**
     * Deletes an existing Reclame model.
    ...
    /**
     * Finds the Reclame model based on its primary key value.
    ...
    {
        if (($model = Reclame::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionSortImage($id)
    {
        if(Yii::$app->request->isAjax){
            ...
            ImageManager::updateAllCounters(['sort' => $counter], [
                'and',['class'=>'reclame','item_id'=>$id],$param
            ]);
