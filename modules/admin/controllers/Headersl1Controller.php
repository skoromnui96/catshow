...
use app\models\Headersl1\Headersl1Search;
...
/**
 * Headersl1Controller implements the CRUD actions for Headersl1 model.
 */
class Headersl1Controller extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Updates an existing Headersl1 model.
    ...
    /**
     * Deletes an existing Headersl1 model.
    ...
    /**
     * Finds the Headersl1 model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Headersl1 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Headersl1::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionSortImage($id)
    {
        if(Yii::$app->request->isAjax){
            ...
            ImageManager::updateAllCounters(['sort' => $counter], [
                'and',['class'=>'headersl1','item_id'=>$id],$param
            ]);
