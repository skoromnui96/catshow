...
use app\models\Organizers\OrganizersSearch;
...
/**
 * OrganizersController implements the CRUD actions for Organizers model.
 */
class OrganizersController extends Controller
{
    ...
    /**
     * Displays a single Organizers model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new Organizers model.
    ...
    /**
     * Updates an existing Organizers model.
    ...
    /**
     * Deletes an existing Organizers model.
    ...
    /**
     * Finds the Organizers model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Organizers the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Organizers::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionSortImage($id)
    {
        if(Yii::$app->request->isAjax){
            ...
            ImageManager::updateAllCounters(['sort' => $counter], [
                'and',['class'=>'organizers','item_id'=>$id],$param
            ]);
