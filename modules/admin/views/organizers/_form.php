...
<div class="organizers-form">
    ...
    <?= FileInput::widget([
        ...
        'pluginOptions' => [
            'deleteUrl' => Url::toRoute(['/admin/organizers/delete-image']),
            'initialPreview'=> $model->imagesLinks,
            'initialPreviewAsData'=>true,
            'overwriteInitial'=>false,
            'initialPreviewConfig'=>$model->imagesLinksData,
            'uploadUrl' => Url::to(['/admin/organizers/save-img']),
            'uploadExtraData' => [
        ...
        'pluginEvents' => [
            'filesorted' => new \yii\web\JsExpression('function(event, params){
                  $.post("'.Url::toRoute(["/admin/organizers/sort-image","id"=>$model->id]).'",{sort: params});
            }')
        ],
